...
Decidim::Webpacker.register_entrypoints(
  email: "#{base_path}/app/packs/entrypoints/email.css",
  email_ks_templates: "#{base_path}/app/packs/entrypoints/email_ks_templates.css",
  decidim_core_extended: "#{base_path}/app/packs/entrypoints/decidim_core_extended.js",
  core_extended_pages: "#{base_path}/app/packs/entrypoints/pages.js",
  core_extended_survey_questions_scroll: "#{base_path}/app/packs/entrypoints/survey_questions_scroll.js"
)
