/*
 * File overritten to prevent drag & drop functionality on disabled questionnaire summary screen
 */
...
$(() => {
  ...
  // CUSTOM: Only enable drag & drop if form is not disabled
  document
    .querySelectorAll(".js-sortable-check-box-collection")
    .forEach((el) => {
      const $form = $(el).closest("form");
      const isFormDisabled = $form.hasClass("answer-questionnaire--disabled");
  ...
  $(".answer-questionnaire .question[data-conditioned='true']").each(
    (idx, el) => {
