  ...
  MultiSelect.prototype = {
    ...
    load: function () {
        ...
        .on("click.ms-hideopts", function (event) {
          if (!$(event.target).closest(".ms-options-wrap").length) {
            $(".ms-options-wrap.ms-active > .ms-options").each(function () {
              ...
              $(this).closest(".ms-options-wrap").find(">button").attr("aria-expanded", "false");
      ...
      placeholder
        .on("mousedown", function (event) {
          ...
          optionsWrap.parent().find(">button").attr("aria-expanded", "true");
      ...
      optionsWrap.on("click", ".ms-submitform", function (event) {
        ...
        var vote_btn_js = form.find(".button-search");
        ...
        if (vote_btn_js.length > 0) {
          ...
          if (
            ...
            form.attr("id")?.includes("edit_user")
          ) {
            $(this).closest(".ms-options-wrap").removeClass("ms-active");
            $(this).closest(".ms-options-wrap").find(">button").attr("aria-expanded", "false");
          } else {
    ...
    _updatePlaceholderText: function () {
      ...
      // if copy is larger than button width use "# selected"
        ...
        placeholderTxt.html(
          instance.options.texts.selectedOptions +
            " " +
            selectVals.length +
