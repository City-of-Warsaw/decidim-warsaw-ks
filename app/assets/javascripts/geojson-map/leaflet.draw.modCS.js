...
const drawToolbar = {
  ...
  buttons: {
    polyline: "Zaznacz linię",
    polygon: "Zaznacz powierzchnię",
    rectangle: "Wyznacz prostokąt",
    circle: "Wyznacz koło",
    marker: "Zaznacz punkt",
...
const editToolbar = {
  ...
  buttons: {
    edit: "Edytuj znaczniki",
    editDisabled: "Brak znaczników do edycji",
    remove: "Usuń znaczniki",
    removeDisabled: "Brak znaczników do usunięcia",
  },
};
        ...
        L.Draw.Feature.prototype.addHooks.call(this),
          this._map &&
            ...
            this._mouseMarker
              ...
              .on("mouseup touchend", this._onMouseUp, this)
              .addTo(this._map),
            this._map
              .on("mouseup touchend", this._onMouseUp, this)
              .on("mousemove", this._onMouseMove, this)
      ...
      removeHooks: function () {
        L.Draw.Feature.prototype.removeHooks.call(this),
          ...
          this._mouseMarker
            ...
            .off("mouseup touchend", this._onMouseUp, this)
    ...
    (L.Draw.SimpleShape = L.Draw.Feature.extend({
      ...
      removeHooks: function () {
        L.Draw.Feature.prototype.removeHooks.call(this),
          this._map &&
            ...
            L.DomEvent.off(e, "mouseup touchend", this._onMouseUp, this),
      ...
      _onMouseDown: function (t) {
        (this._isDrawing = !0),
          ...
          L.DomEvent.on(e, "mouseup touchend", this._onMouseUp, this)
    ...
    (L.Toolbar = L.Class.extend({
      ...
      _createButton: function (t) {
        ...
        return (
          L.DomEvent.on(e, "click", L.DomEvent.stopPropagation)
            .on(e, "mousedown touchstart", L.DomEvent.stopPropagation)
      ...
      _disposeButton: function (t, e) {
        ...
        L.DomEvent.off(t, "click", L.DomEvent.stopPropagation)
          .off(t, "mousedown touchstart", L.DomEvent.stopPropagation)
