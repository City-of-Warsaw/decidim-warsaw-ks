(function (global, factory) {
    ...
    var DrawAreaSelection = leaflet.Control.extend({
        ...
        onAdd: function onAdd(map) {
            ...
            // CS-mod:
            // modified to skip Rails events propagation on button inside form tag
            this.activateButton = leaflet.DomUtil.create('div', 'leaflet-area-selector-btn', this._container);
        ...
        addUserHelpPanel: function addUserHelpPanel(pane) {
            ...
            var help = "polyDefine a gon by clicking of the map to define vertexes" + (leaflet.Browser.mobile ? "." : " or click-and-drag to obtain a rectangular shape.");
