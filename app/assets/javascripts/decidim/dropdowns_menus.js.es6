((exports) => {
  ...
  exports.$(() => {
    exports.$("[data-dropdown-menu]").on("show.zf.dropdownMenu", (event, element) => {
      exports.$(event.target).find("#user-menu-control").attr("aria-expanded", "true");
      setTimeout(() => exports.$(event.target).find("#user-menu-control").focus(), 10); 
    });
    exports.$("[data-dropdown-menu]").on("hide.zf.dropdownMenu", (event, _element) => { 
      exports.$(event.target).find("#user-menu-control").attr("aria-expanded", "false");
    });
  });
