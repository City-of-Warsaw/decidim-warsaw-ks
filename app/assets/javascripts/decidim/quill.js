          ...
          _createClass(SnowTheme, [
            {
              ...
              value: function extendToolbar(toolbar) {
                ...
                if (toolbar.container.querySelector(".ql-button")) {
                  this.quill.keyboard.addBinding(
                    { key: "K", shortKey: true },
                    function (range, context) {
                      toolbar.handlers["button"].call(
                        toolbar,
                ...
                this.root
                  ...
                  .addEventListener("click", function (event) {
                    if (_this3.root.classList.contains("ql-editing")) {
                      ...
                      if (
                        _this3.preview.getAttribute("data-link-type") === "link"
                      ) {
                        _this3.edit("link", _this3.preview.textContent);
                      } else if (
                        _this3.preview.getAttribute("data-link-type") ===
                        "button"
                      ) {
                        _this3.edit("button", _this3.preview.textContent);
                      }
                    }
                    event.preventDefault();
                  });
                  ...
                  function (range, oldRange, source) {
                    ...
                    if (
                      ...
                      if (link != null) {
                        ...
                        if (link.domNode.classList.contains("ql-button")) {
                          _this3.preview.setAttribute(
                            "data-link-type",
                            "button"
                          );
                        } else {
                          _this3.preview.setAttribute("data-link-type", "link");
                        }
