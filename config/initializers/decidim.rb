...
Decidim.configure do |config|
  ...
  config.application_name = "Decidim Warszawa Konsultacje Społeczne"

  # The email that will be used as sender in all emails from Decidim
  config.mailer_sender = "test@konsultacje.warszawa.pl"
  ...
  config.available_locales = [:pl, :en] # english required for tests
