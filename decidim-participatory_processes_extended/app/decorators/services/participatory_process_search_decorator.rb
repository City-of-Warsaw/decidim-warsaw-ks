...
# Searchlight zostal usuniety, nalezy sprawdzic i uzupelnic w nowym mechanizmie wyszukiwanie
...
#   end
#
#   def search_selected_scopes
#     selected_scope_ids = selected_scopes.reject(&:blank?)
#     return query unless selected_scope_ids.any?
#
#     query.joins(:process_scopes).where("decidim_participatory_processes_extended_process_scopes.decidim_scope_id": selected_scope_ids).distinct
#   end
#
