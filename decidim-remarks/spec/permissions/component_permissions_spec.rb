...
describe Decidim::Admin::Permissions do
  ...
  ### remarks component tests

  context "when reading the admin expert_questions component" do
    let(:action) do
  ...
  context "when creating the admin remarks component" do
    let(:action) do
  ...
  context "when updating the admin remarks component" do
    let(:action) do
  ...
  context "when publishing the admin remarks component" do
    let(:action) do
